...
完整的一次性设置见 CLOUD_SYNC_SETUP.md。激活链接在 Safari 打开后看不到旧记录时，保留所有图标，回到原来有记录的图标，在“备份”中直接粘贴完整激活链接即可迁移原记录。
...
线上 V2.2.1 已发布；Cloudflare 同步服务已就绪，首次真实 iPhone 迁移仍需单独确认。
